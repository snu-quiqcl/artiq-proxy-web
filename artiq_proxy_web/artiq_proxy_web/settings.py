"""
Django settings for artiq_proxy_web project.
...
SECRET_KEY = 'django-insecure-_z@9vn29)429y2%qyb3ujkl8$+(078^dz6zvpsye(*6gp#lpat'
...
ROOT_URLCONF = 'artiq_proxy_web.urls'
...
WSGI_APPLICATION = 'artiq_proxy_web.wsgi.application'
